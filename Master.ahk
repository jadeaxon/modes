...
:*:Ar7::
	...
	remind("reboot Surface (for Zoom) at 5 AM on Monday")
	...
	remind("reboot Surface (for Zoom) at 5 AM on Tuesday")
	remind("check recent ESS tickets https://uvu-it.atlassian.net/issues/?filter=10824 at 5 AM on Tuesday")
	remind("check unwatched ESS tickets https://uvu-it.atlassian.net/issues/?filter=10916 at 5 AM on Tuesday")
	remind("check unwatched UPM tickets https://solutionstream.atlassian.net/issues/?filter=13388 at 5 AM on Tuesday")
	...
	remind("reboot Surface (for Zoom) at 5 AM on Wednesday")
	...
	remind("reboot Surface (for Zoom) at 5 AM on Thursday")
	...
	remind("reboot Surface (for Zoom) at 5 AM on Friday")
